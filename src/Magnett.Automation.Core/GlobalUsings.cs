...
global using Magnett.Automation.Core.Commons;
global using Magnett.Automation.Core.Contexts;
global using Magnett.Automation.Core.Contexts.Implementations;
